...
# this is the code to be used only on the raspberrypi. Do not use on PC
...
# dbloc = "https://teams.connect.bh.com/sites/bpmo/projectX/flighttest/62014/Shared%20Documents/Equipment%20Inventory/InventoryManager.db" # doesn't work with the sharepoint
...
# deletes the previous file from github when called
def delete_file():
    token = "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"
    repo_owner = "ngee99"
    repo_name = "invmanager"
    file_path = "InventoryManager.db"
...
# uploads the new version of the file when called
def upload_file():
    token = "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"
    repo_owner = "ngee99"
    repo_name = "invmanager"
    ...
    # sets the current unix time and converts to regular people time
    now = int(time.time())
    nowtime = datetime.datetime.fromtimestamp(now)
    print(nowtime)

    # encodes the contents as base64
    with open("/home/bellinv/Documents/Inventory_Management/InventoryManager.db", "rb") as f:
        content = f.read()
...
class App():
    ...
    def __init__(self):
        ...
        bg_image = tk.PhotoImage(file="/home/bellinv/Documents/Inventory_Management/testimage.png")
